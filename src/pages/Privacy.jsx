    ...
    <div className="page">
      ...
      <section className="section bg-white">
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <h2>4. Your Rights</h2>
          <p>You can request to update, purge, or retrieve your profile data at any time by contacting our privacy compliance team at <a href="mailto:privacy@ascendhr.com">privacy@ascendhr.com</a>.</p>
        </div>
      </section>
    </div>
  );
